...
If you want to go the easy route just copy the bin file onto your SD card in the motherboard (not TFT) and wait a while for a reboot. Once it is done you should have a FIRMWARE.CUR fie on the SD. That menas it worked.
